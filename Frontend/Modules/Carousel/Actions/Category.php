...
/**
 * This is the category-action, it will display the overview of Carousel categories
 *
...
class Category extends Block
{
    ...
    private function getData()
    {
        ...
        // get category
        $this->category = FrontendCarouselModel::getCategory($this->URL->getParameter(0));
        ...
        // set URL and limit
        $this->pagination['url'] = Navigation::getURLForBlock('Carousel', 'category') . '/' . $this->category['url'];

        $this->pagination['limit'] = $this->get('fork.settings')->get('Carousel', 'overview_num_items', 10);

        // populate count fields in pagination
        $this->pagination['num_items'] = FrontendCarouselModel::getCategoryCount($this->category['id']);
        ...
        // get items
        $this->items = FrontendCarouselModel::getAllByCategory(
