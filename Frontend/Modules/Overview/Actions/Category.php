...
namespace Frontend\Modules\Overview\Actions;
...
/**
 * This is the category-action, it will display the overview of Overview categories
 *
...
class Category extends Block
{
    ...
    private function getData()
    {
        ...
        // get category
        $this->category = FrontendOverviewModel::getCategory($this->URL->getParameter(0));
        ...
        // set URL and limit
        $this->pagination['url'] = Navigation::getURLForBlock('Overview', 'category') . '/' . $this->category['url'];

        $this->pagination['limit'] = $this->get('fork.settings')->get('Overview', 'overview_num_items', 10);

        // populate count fields in pagination
        $this->pagination['num_items'] = FrontendOverviewModel::getCategoryCount($this->category['id']);
        ...
        // get items
        $this->items = FrontendOverviewModel::getAllByCategory(
