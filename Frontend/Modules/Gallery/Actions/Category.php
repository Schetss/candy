...
/**
 * This is the category-action, it will display the overview of Gallery categories
 *
...
class Category extends Block
{
    ...
    private function getData()
    {
        ...
        // get category
        $this->category = FrontendGalleryModel::getCategory($this->URL->getParameter(0));
        ...
        // set URL and limit
        $this->pagination['url'] = Navigation::getURLForBlock('Gallery', 'category') . '/' . $this->category['url'];

        $this->pagination['limit'] = $this->get('fork.settings')->get('Gallery', 'overview_num_items', 10);

        // populate count fields in pagination
        $this->pagination['num_items'] = FrontendGalleryModel::getCategoryCount($this->category['id']);
        ...
        // get items
        $this->items = FrontendGalleryModel::getAllByCategory(
