...
namespace Frontend\Modules\ImageBlock\Actions;
...
/**
 * This is the category-action, it will display the overview of Image Block categories
 *
...
class Category extends Block
{
    ...
    private function getData()
    {
        ...
        // get category
        $this->category = FrontendImageBlockModel::getCategory($this->URL->getParameter(0));
        ...
        // set URL and limit
        $this->pagination['url'] = Navigation::getURLForBlock('ImageBlock', 'category') . '/' . $this->category['url'];

        $this->pagination['limit'] = $this->get('fork.settings')->get('ImageBlock', 'overview_num_items', 10);

        // populate count fields in pagination
        $this->pagination['num_items'] = FrontendImageBlockModel::getCategoryCount($this->category['id']);
        ...
        // get items
        $this->items = FrontendImageBlockModel::getAllByCategory(
