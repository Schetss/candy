...
class Add extends ActionAdd
{
    ...
    protected function loadForm()
    {
        ...
        $this->frm->addText('title_1');
        $this->frm->addText('title2');
        $this->frm->addText('title3');
        $this->frm->addText('title4');
        $this->frm->addText('title5');
        $this->frm->addText('title6');
        $this->frm->addText('title7');
        $this->frm->addText('title8');
        $this->frm->addText('title9');
        ...
        $this->frm->addText('linkurl1');
        $this->frm->addText('linkurl2');
        $this->frm->addText('linkurl3');
        $this->frm->addText('linkurl4');
        $this->frm->addText('linkurl5');
        $this->frm->addText('linkurl6');
        $this->frm->addText('linkurl7');
        $this->frm->addText('linkurl8');
        $this->frm->addText('linkurl9');
        ...
        if ($this->frm->isSubmitted()) {
            ...
            if ($this->frm->isCorrect()) {
               ...
               if (!\SpoonDirectory::exists($imagePath . '/160x160')) {
                ...
                $item['sequence'] = BackendImageBlockModel::getMaximumSequence() + 1;
                $item['category_id'] = $this->frm->getField('category_id')->getValue();

                $item['meta_id'] = $this->meta->save();

                // insert it
                $item['id'] = BackendImageBlockModel::insert($item);
