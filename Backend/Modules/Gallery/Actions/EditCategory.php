...
class EditCategory extends ActionEdit
{
    ...
    private function getData()
    {
        ...
        $this->record = BackendGalleryModel::getCategory($this->id);
    }
    ...
    private function loadForm()
    {
        ...
        $this->meta->setUrlCallback('Backend\Modules\Gallery\Engine\Model', 'getURLForCategory', array($this->record['id']));
    }
